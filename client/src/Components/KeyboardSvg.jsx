...
import '../styles/keyboardStyle.scss'
...
const KeyboardSvg = () => {
    useEffect(()=>{
        ...
        setInterval(()=>{
            i=((i+1)%17); if(i===0) i++;
            document.querySelector(`#toPress >path:nth-of-type(${i})`).classList.add('current');
            setTimeout(function(){ 
                document.querySelector(`#toPress >path:nth-of-type(${i})`).classList.remove('current')
            }, 150);
        },300)
